...
## Supported Phonopy Versions

- Fully compatible with **phonopy 2.3 → 2.4+**
- Handles both:
  - Older `PhonopyAtoms` that behave like ASE Atoms  
  - Newer ones that only have `.symbols`  

---

## Known Limitations

- Does not generate Phonopy supercells  
- Does not support non-diagonal supercells  
- Does not read stress tensors  
- Only works with **Type-1 FORCE_SETS**

---

## Citation

If you use this script for research publications, please cite:

- **Phonopy:**  
  Togo & Tanaka, *Scr. Mater.* 108, 1–5 (2015).  
- **DFT-FE:**  
  Motamarri *et al.*, *J. Comput. Phys.* 253, 308–343 (2013).  
  Das *et al.*, *npj Comput. Mater.* 8, 197 (2022).
